...
import frsf.cidisi.exercise.informada.search.EstadoAmbiente;
...
public class DronePerception extends Perception {
	...
	private int[] antena; // Array de 5 posiciones que da la intensidad de las señales en los cuadrantes/subcuadrantes respectivos
	/*
