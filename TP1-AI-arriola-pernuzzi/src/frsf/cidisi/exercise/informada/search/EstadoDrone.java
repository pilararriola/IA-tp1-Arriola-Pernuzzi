...
public class EstadoDrone extends SearchBasedAgentState {
    ...
    public void updateState(Perception p) {
    	...
    	case 2://Nivel alto
    		//Seteo la columna 0 de la matriz de señales
        	for(int i=0;i<4;i++){
    	...
    	case 1://Nivel medio
    		...
    		//Seteo la fila que corresponde al cuadrante en el que estoy (con las señales de sus subcuadrantes)
    		for(int i=0;i<4;i++){
    ...
    public void initState() {
		...
		/*
		 ...
		 Las columnas se asignan de la siguiente manera:
		  ...
		  dentro de qué cuadrante se ubica el mismo.
		 */
		...
		/*
		 ...
		 se encuentra en el nivel medio, del cuadrante en el que está metido.
		 */
